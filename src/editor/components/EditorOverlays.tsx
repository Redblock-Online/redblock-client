  ...
  return (
    <main className="pointer-events-none relative flex-1">
      <div className="pointer-events-none absolute inset-0">
        <div className=" left-4 top-4 flex max-w-md flex-col gap-1.5 rounded border border-[#1a1a1a] bg-[#323232]/95 px-3 py-2.5 text-[13px] text-[#cccccc]">
          <span className="text-[12px] text-[#999999] mb-0.5">
            Controls
          </span>
          <span className="leading-relaxed text-[12px]">Orbit with right click · Pan with Shift + right click · Zoom with scroll</span>
          <span className="leading-relaxed text-[12px]">
            Select with left click · Move (G) · Rotate (R) · Scale (F) · constrain with X / Y / Z
          </span>
          <span className="leading-relaxed text-[12px]">Move camera with WASD</span>
          {transformLabel ? (
            <span className="mt-1 w-fit rounded border border-[#1a1a1a] bg-[#4772b3] px-2.5 py-1 text-[12px] text-white">
              {transformLabel}
            </span>
          ) : null}
        </div>

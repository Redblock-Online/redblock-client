...
export function PropertiesPanel({
  ...
  const actionButtonClass =
    "h-9 rounded-md bg-editor-accent text-editor-sm font-medium text-white transition-all duration-150 hover:bg-editor-accentHover shadow-sm";
  const subtleButtonClass =
    "h-9 rounded-md border border-editor-border bg-white text-editor-sm font-medium text-editor-text transition-all duration-150 hover:bg-editor-surface";

  if (!selection) {
    return (
      <div className="flex h-full flex-col items-center justify-center gap-3 rounded-lg border border-dashed border-editor-border bg-white p-5 text-center text-editor-sm text-editor-muted">
    ...
    <div className="flex h-full flex-col gap-4 text-editor-sm text-editor-text">
      <div>
        ...
        <div className="mt-1 flex items-center gap-2 text-editor-base font-semibold text-editor-text">
          ...
          {isComponent && (
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#9333ea" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="flex-shrink-0">
          ...
          {isEditingName ? (
            <input
              ...
              autoFocus
              className="flex-1 rounded-md border border-editor-accent bg-white px-2.5 py-1.5 text-editor-sm text-editor-text outline-none"
            />
          ) : (
            <div className="group flex flex-1 items-center gap-1.5 cursor-pointer hover:text-editor-accent transition-all duration-150" onClick={() => {

 ...
 * Displays the login form with Redblock branding
 */
  ...
  return (
    <div className="fixed inset-0 bg-[radial-gradient(#fff,#fff)] flex flex-col items-center justify-center text-black">
      ...
      <div className="relative  z-10 flex flex-col items-center justify-center w-full max-w-2xl">
        ...
        {/* Title */}
        <h1 className="text-4xl font-bold mb-2 uppercase tracking-wider">Login</h1>
        <p className="text-sm opacity-60 mb-8">Sign in to your Redblock account</p>

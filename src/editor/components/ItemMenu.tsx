        ...
        return (
          ...
          >
            ...
            <div className="flex items-center gap-1">
              {isComponent && (
                <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={isActive ? "text-[#4772b3]" : "text-[#4772b3] opacity-70"}>
